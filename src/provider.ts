...
import { InvalidSubjectError } from "@openauthjs/openauth/error";
...
/**
 * Creates a SAML (browser post) provider for OpenAuth
 * @param config - Provider configuration options
 * @returns Provider implementation that handles SAML authentication
 * @example
 */
export function SamlAdapter(
  config: SamlConfig,
): Provider<{ claims: SamlClaims}> {
  return {
